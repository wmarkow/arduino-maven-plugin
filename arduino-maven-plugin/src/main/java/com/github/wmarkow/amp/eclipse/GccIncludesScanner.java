...
public class GccIncludesScanner
{
    ...
    private List<File> scanForDefaultCIncludes(File pathToGccExecutable) throws IOException, InterruptedException
    {
    ...
    private List<File> scanForDefaultCppIncludes(File pathToGccExecutable) throws IOException, InterruptedException
    {
        List<String> cmd = new ArrayList<String>();
    ...
    private List<File> scanForDefaultAsmIncludes(File pathToGccExecutable) throws IOException, InterruptedException
    {
        List<String> cmd = new ArrayList<String>();
    ...
    private List<File> scanForDefaultIncludes(List<String> commandArguments) throws IOException, InterruptedException
    {
        File bogusTestFile = new File(BOGUS_TEST_FILE);
        FileUtils.forceMkdir(bogusTestFile.getParentFile());
        FileUtils.touch(bogusTestFile);

        CommandExecutor cmd = new CommandExecutor();
        GccIncludesScannerStreamGobbler gccIncludesScannerStreamGobbler = new GccIncludesScannerStreamGobbler();
